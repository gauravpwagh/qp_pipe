...
all-English "Part A" (per the exam's own definition, e.g. Q1-100) followed
by a bilingual "Part B" where every item is printed twice - once in Hindi,
once in English - alternating by page (Hindi first, then its English
match). Confirmed by direct inspection of
QP-NDANA-II-26-GENERAL-ABILITY-TEST-140926.pdf (52 pages): page 1 is Hindi
instructions, pages 2-27 are Part A (English only, two-column, every page
processed), pages 28-47 are Part B (28/30/32/... Hindi, 29/31/33/...
English), pages 48-51 are rough-work, and page 52 is an English
